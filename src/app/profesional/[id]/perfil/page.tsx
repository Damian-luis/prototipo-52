...
// Interfaz para el perfil del profesional
...
const ProfesionalPerfilPage = () => {
  ...
  const loadProfessionalProfile = async () => {
    try {
      setLoading(true);
      // Hacer la petición directamente sin autenticación para perfiles públicos
      const response = await axios.get(`${process.env.NEXT_PUBLIC_API_URL || 'http://localhost:3000'}/users/${professionalId}/profile/public`);
  ...
  const handleContactProfessional = async () => {
    ...
    try {
      // Para contacto, necesitamos autenticación
      showInfo('Para contactar al profesional, por favor inicia sesión');
  ...
  const handleDownloadCV = async () => {
    ...
    try {
      showInfo('Para descargar el CV, por favor inicia sesión');
    } catch (error) {
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg p-6 w-full max-w-md mx-4">
            ...
            <div className="mb-4">
              <p className="text-gray-600 dark:text-gray-400 mb-4">
                Para contactar al profesional, necesitas iniciar sesión en la plataforma.
              </p>
              <Button
                variant="primary"
