...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    subItems: [
      ...
      { name: "Mis Aplicaciones", path: "/freelancer/jobs/applications" },
      { name: "Trabajos Activos", path: "/freelancer/jobs/active" },
    ],
  },
  {
    icon: <File />,
  ...
  },
  {
    ...
    subItems: [
      ...
      { name: "Pagos Pendientes", path: "/freelancer/payments/pending" },
      { name: "Métodos de Pago", path: "/freelancer/payments/methods" },
    ],
  },
  {
    icon: <ShootingStar />,
    ...
    subItems: [
      ...
      { name: "Certificaciones", path: "/freelancer/performance/certifications" },
      { name: "Estadísticas", path: "/freelancer/performance/stats" },
    ],
  },
  {
    icon: <PieChart />,
